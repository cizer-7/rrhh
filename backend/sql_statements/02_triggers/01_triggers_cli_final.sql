-- ============================================================================
-- TRIGGER OHNE DELIMITER FÜR CLI
-- ============================================================================

-- Trigger 1: BEFORE INSERT für t002_salarios
...
-- Trigger 2: BEFORE UPDATE für t002_salarios
...
-- Trigger 3: AFTER INSERT für t001_empleados (erstellt monatliche Datensätze)
