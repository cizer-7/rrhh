...
export default function SalaryCopyManager() {
  ...
  const fetchMissingYears = async () => {
    try {
      const response = await fetch('https://salary-management.azurewebsites.net/salaries/missing-years', {
        headers: {
  ...
  const handleCopySalaries = async (year: number) => {
    ...
    try {
      const response = await fetch(`https://salary-management.azurewebsites.net/salaries/copy-to-year/${year}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json'
  ...
  const handleCreateNewYear = async () => {
    ...
    try {
      const response = await fetch(`https://salary-management.azurewebsites.net/salaries/copy-to-year/${newYear}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json'
